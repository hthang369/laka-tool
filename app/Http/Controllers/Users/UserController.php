...
class UserController extends CoreController
{
    ...
    public function __construct(UserRepository $repository, UserValidator $validator)
    {
        ...
        if (str_is(last(\request()->segments()), 'update-password')) {
            View::share('titlePage', __('users.page_title_update_password'));
            View::share('headerPage', 'users.page_header_update_password');
        } else {
