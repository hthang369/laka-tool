...
class UserGridPresenter extends CoreGridPresenter
{
    ...
    {
        return $item->status != 1 && $item->role_rank >= $this->getAuthRoleRank() && parent::visibleEdit($item); // TODO: Change the autogenerated stub
    }

    protected function visibleDelete($item)
    {
        return  $item->status != 1 && $item->role_rank >= $this->getAuthRoleRank() && parent::visibleDelete($item); // TODO: Change the autogenerated stub
    }
